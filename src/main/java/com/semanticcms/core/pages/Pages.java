...
public interface Pages {
	 ...
	 *
	 * @throws  IOException  if I/O error occurs
	 * @throws  FileNotFoundException  if page does not exist (see {@link #exists(java.lang.String)})
	 */
	Page getPage(Path path, CaptureLevel level) throws IOException, FileNotFoundException;
}
